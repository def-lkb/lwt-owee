...
Relevant parts:
- [`Lwt_unix.trace`](https://github.com/def-lkb/lwt-owee/blob/master/src/unix/lwt_unix.mli#L1199)
- [`Lwt.successors` and `Lwt.user_location`](https://github.com/def-lkb/lwt-owee/blob/master/src/core/lwt.mli#L487)
